...
class ReplaceNotificationSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'categories' => ['required', 'array:routine,storage,habit,sleep,workout,supplement,finance'],
            ...
            'categories.workout' => ['sometimes', 'boolean'],
            'categories.supplement' => ['sometimes', 'boolean'],
            'categories.finance' => ['sometimes', 'boolean'],
        ];
    }
